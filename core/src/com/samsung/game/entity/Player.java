...
public class Player extends Entity {
    ...
    public void update() {
        if (Game.platform.equals("Android") && androidTouch()){
            move();
        }else if (Game.platform.equals("PC") && (Gdx.input.isKeyPressed(Input.Keys.W) || Gdx.input.isKeyPressed(Input.Keys.S) || Gdx.input.isKeyPressed(Input.Keys.A) || Gdx.input.isKeyPressed(Input.Keys.D))){
            move();
        }
...
//        System.out.println("Player: X:" + worldX + "  Y:" + worldY);
    ...
    private boolean androidTouch(){
        return (Gdx.input.isTouched() && (KeyHandler.upTouch() || KeyHandler.downTouch() || KeyHandler.leftTouched() || KeyHandler.rightTouch()));
    }
